<x-layouts>
                    ...
                    <div
                        ...
                        <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                            <div class="flex items-center">
                                <p class="mb-0 font-bold dark:text-white/80">Etalase Barang</p>
                                <a href="{{ url('barang') }}"
                        ...
                        <div class="flex-auto p-6">
                            <table id="example" style="text-align: center !impo"
    ...
    <script>
        ...
        function formatRupiah(angka) {
            // 1. Bulatkan angka (misalnya, ke satuan terdekat)
            let angkaBulat = Math.round(angka);

            // 2. Ubah angka ke string
            let angkaString = String(angkaBulat);

            // 3. Gunakan regex untuk menambahkan titik pemisah ribuan
            let formattedAngka = angkaString.replace(/\B(?=(\d{3})+(?!\d))/g, '.');
